    ...
    <div className={ProductsStyle.products}>
      ...
      <div id="product" className={ProductsStyle.container}>
        ...
        <div className="card text-left">
          ...
          <div className="card-body">
            ...
            <button className={ProductsStyle.button}>Chi Tiết ></button>
          </div>
        </div>
      ...
      <div id="product" className={ProductsStyle.container}>
        ...
        <div className="card text-left">
          <img
            className="card-img-top"
            src="http://www.vanthinhseafoods.com/images/Sanphamseafood/SWIMMING%20CRAB%20-%20Ghe/Three%20Spot%20Crab%201.jpg"
            alt="ca-bien, ca-bien-xuat-khau, ca-bien-khoi-xa."
          />
          <div className="card-body">
            <h5 className="card-title">Ghẹ Biển</h5>
            <p className="card-text text-danger">Giá bán: 120,000đ</p>
            <button className={ProductsStyle.button}>Chi Tiết ></button>
          </div>
        </div>
        ...
        <div className="card text-left">
          <img
            className="card-img-top"
            src="http://www.vanthinhseafoods.com/images/Sanphamseafood/SWIMMING%20CRAB%20-%20Ghe/DSC01218.jpg"
            alt="ca-bien, ca-bien-xuat-khau, ca-bien-khoi-xa."
          />
          <div className="card-body">
            <h5 className="card-title">Ghẹ Xanh</h5>
            <p className="card-text text-danger">Giá bán: 180,000đ</p>
            <button className={ProductsStyle.button}>Chi Tiết ></button>
          </div>
        </div>
        ...
        <div className="card text-left">
          <img
            className="card-img-top"
            src="http://www.vanthinhseafoods.com/images/Sanphamseafood/CUTTLEFISH%20-%20Muc%20nang/Shell%20cuttlefish02.jpg"
            alt="ca-bien, ca-bien-xuat-khau, ca-bien-khoi-xa."
          />
          <div className="card-body">
            <h5 className="card-title">Mực Nang vừa</h5>
            <p className="card-text text-danger">Giá bán: 220,000đ</p>
            <button className={ProductsStyle.button}>Chi Tiết ></button>
          </div>
        </div>
        ...
        <div className="card text-left">
          <img
            className="card-img-top"
            src="http://www.vanthinhseafoods.com/images/Sanphamseafood/OCTOPUS%20-%20Bach%20tuoc/WCO%201skin02.jpg"
            alt="ca-bien, ca-bien-xuat-khau, ca-bien-khoi-xa."
          />
          <div className="card-body">
            <h5 className="card-title">Bạch Tuột Nhỏ</h5>
            <p className="card-text text-danger">Giá bán: 150,000đ</p>
            <button className={ProductsStyle.button}>Chi Tiết ></button>
          </div>
        </div>
